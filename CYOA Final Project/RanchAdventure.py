...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ending = (
                "After years of hard work, you and your team successfully recreate ranch! "
                "The world is saved! Unfortunately, your team got greedy and silenced you, "
                "monopolizing ranch as a delicacy for the elite. \nBetrayal Ending (1/5)"
            )
            print_end_message(name, ending)
            ...
            if bal == "1":
                ...
                if exp == "1":
                    ...
                    if sup == "1":
                        ending = "Super Ranch for everyone! You are hailed as The Ranch Savior! With your Super Ranch, you are unstoppable! \nYou set up mass predictions factories and pay your employees in Ranch servings. You make billions and there are dog parks and shrines named in your honor.\nEnding (5/5)"
                    else:
                        ending = "You keep Super Ranch all to yourself and live in ranch bliss! The world slowly recovers from the loss of ranch. \nYou however, are living your best Ranch life! \nSelfish Ending (4/5)"
                    print_end_message(name, ending)
